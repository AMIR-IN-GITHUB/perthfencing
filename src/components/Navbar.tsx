...
const Navbar = () => {
  ...
  return (
    <header 
      className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-white shadow-md py-0"
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        <div className="flex items-center">
          <div className="bg-white rounded-full p-1 flex items-center justify-center" style={{ width: 96, height: 96 }}>
        ...
        <div className="hidden md:flex items-center">
          <Button 
            className="bg-fence-600 hover:bg-fence-700 text-white flex items-center gap-2"
            onClick={() => {
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            ...
            <Button 
              className="bg-fence-600 hover:bg-fence-700 text-white flex items-center gap-2 w-full justify-center"
              onClick={() => {
